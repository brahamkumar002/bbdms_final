...
if (isset($_POST['send'])) {
    ...
    $sql = "INSERT INTO  tblbloodrequirer(BloodDonarID,name,EmailId,ContactNumber, Age,BloodGroup,BloodRequirefor,Message) VALUES(:cid,:name,:email,:contactno,:age,:bloodgroup,:brf,:message)";
                    ...
                    <form action="#" method="post">
                        <div class="d-flex space-d-flex">
                            ...
                            <div class="form-group grid-inputs">
                                ...
                                <input type="tel" class="form-control" id="age" name="age" placeholder="Please enter Age.">
                            </div>
