...
<label class="col-sm-2 control-label">Suger level <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="sugerlevels" class="form-control" required>
</div><br><br>

<label class="col-sm-2 control-label">Body Temprature <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="bodytemprature" class="form-control" required>
</div><br><br>

<label class="col-sm-2 control-label">Any disease (Specify) <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="anydisease" class="form-control" required>
</div><br><br>

<label class="col-sm-2 control-label">Pulse Rate <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="pulserate" class="form-control" required>
</div><br><br>

<label class="col-sm-2 control-label">Blood Pressure <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="bloodpressure" class="form-control" required>
</div><br>

<label class="col-sm-2 control-label">Hemoglobin <span style="color:red">*</span></label>
<div class="col-sm-4">
