...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->Sugerlevels);?></td>
											<td><?php echo htmlentities($result->Bodytemprature);?></td>
											<td><?php echo htmlentities($result->Anydisease);?></td>
											<td><?php echo htmlentities($result->Pulserate);?></td>
											<td><?php echo htmlentities($result->Bloodpressure);?></td>
											<td><?php echo htmlentities($result->Hemoglobin);?></td>
...
{?>
<a href="donor-list.php?hidden=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to hiidden this detail')" class="btn btn-primary"> Hide</a> 
<?php } else {?>

<a href="donor-list.php?public=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Public this detail')" class="btn btn-primary">Public</a>
