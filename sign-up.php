...
$status=1;
 ...
 if ($age <= 20) {
	echo "<script>alert('You are not eligible due to age.');</script>";
} elseif ($weight <= 45) {
	echo "<script>alert('You are not eligible due to weight.');</script>";
} else {
...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Weight,Sugerlevels,Bodytemprature,Anydisease,Pulserate,Bloodpressure,Hemoglobin,Gender,BloodGroup,Address,Message,status,Password) VALUES(:fullname,:mobile,:email,:age,:weight,:sugerlevels,:bodytemprature,:anydisease,:pulserate,:bloodpressure,:hemoglobin,:gender,:blodgroup,:address,:message,:status,:password)";
...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            ...
                            <form action="#" method="post"  name="signup" onsubmit="return checkpass();">
								...
								<div class="form-group">
                                    <label class="mb-2">Suger Level</label>
                                    <input type="text" class="form-control" name="sugerlevels" id="sugerlevels" placeholder="Enter suger level" required="">
                                </div>

								<div class="form-group">
                                    <label class="mb-2">Body Temprature</label>
                                    <input type="text" class="form-control" name="bodytemprature" id="bodytemprature" placeholder="Enter Body Temprature" required="">
                                </div>

								<div class="form-group">
                                    <label class="mb-2">Any disease (specify)</label>
                                    <input type="text" class="form-control" name="anydisease" id="anydisease" placeholder="Enter if any disease" required="">
                                </div>

								<div class="form-group">
                                    <label class="mb-2">Pulse Rate</label>
                                    <input type="text" class="form-control" name="pulserate" id="pulserate" placeholder="Enter Pulse Rate" required="">
                                </div>
								...
								<div class="form-group">
                                    <label class="mb-2">Hemoglobin</label>
                                    <input type="text" class="form-control" name="hemoglobin" id="hemoglobin" placeholder="Enter Hemoglobin" required="">
                                </div>
